...
if($_SERVER["REQUEST_METHOD"] == "POST"){	
  ...
  $transcount = 1001 + $transcount;	
	...
	$sql1 = mysqli_query($connection,"INSERT INTO acc_cashbook (`date`, `clusterid`,`groupid`, `TransID`, `subheadid`, `details`, `receiptcash`,`remarks`,`entryempid`,`timedate`)
						VALUES('$today','$clusterid','','$transid', '$subid', '$details','$amount','$details','$user','$timedate')") or die(mysqli_error($connection));	
  ...
  $balance = mysqli_query($connection,"UPDATE acc_cluster_balance SET Balance = Balance + $amount WHERE ClusterID = '$clusterid'");
	...
	$sql4 = mysqli_query($connection,"SELECT acc_subhead.SubHead, acc_cashbook.receiptcash, acc_cashbook.details FROM acc_subhead, acc_cashbook WHERE acc_cashbook.subheadid = acc_subhead.SubID AND acc_cashbook.TransID = '$transid' ");
												...
												<div class="row">   
													...
													<div class="col-md-4">
														<div class="form-group label-floating">												
															...
															<a href="president_cashbook.php"><button type="button" class="btn btn-info btn-fill pull-right"><i class="fa fa-arrow-left" aria-hidden="true"></i>Back</button></a>
														</div>
													</div>                            
												</div>
											</form>                
