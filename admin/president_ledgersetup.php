										...
										<div class="widget-box widget-color-blue2">
											...
											<?php if($count1>0){
												...
												{ 	
													...
													<td onclick = "window.open('/admin/roidetails.php?subhead=<?php echo $row1['subhead']; ?>', '_blank', 'resizable=yes, location=no, scrollbars=yes, width=500, height=400, top=150, left=500'); return false;" > <a href=""> <?php echo $row1['subhead'] ?> </a></td>
													...
													echo "<td width='50px' class='center'> <a href='pdt_ledgersetup_edit.php?subhead=".$row1['subhead']."'>
									...
									<div class="col-sm-6">
										<div class="widget-box widget-color-green2">
											...
											<?php if($count2>0){
												...
												{ 	
													echo "<tr><td class='center'>".$slno."</td>";?>
													<td onclick = "window.open('/admin/roidetails.php?subhead=<?php echo $row2['subhead']; ?>', '_blank', 'resizable=yes, location=no, scrollbars=yes, width=500, height=400, top=150, left=500'); return false;" > <a href=""> <?php echo $row2['subhead'] ?> </a></td>
													<?php //echo "<td width='100px'>".$row2['subhead']."</td>";
													echo "<td width='100px' class='center'>".$row2['roi']."</td>";
													echo "<td style='width:100px;' class='center'>".$row2['doe']."</td>";
													echo "<td width='50px' class='center'> <a href='pdt_ledgersetup_edit.php?subhead=".$row2['subhead']."'>
															  <button class='btn btn-xs btn-info'>
																<i class='ace-icon fa fa-pencil bigger-120'></i>
															  </button>
															  </a></td>";
