<?php	    
  ...
  $sql = mysqli_query($connection,"SELECT * FROM cluster WHERE ClusterName !='Head Office'");
			...
			<div class="main-content">
				<div class="main-content-inner">					
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12"> <!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" method="post" action="pdt_group_suc.php">
                  ...
                  <div class="form-group">
										...
										<div class="col-sm-7">
											<select name="cluster" class="col-xs-10 col-sm-5" autocomplete="off" required>
                        <?php
