					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12"> <!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" method="post" action="pdt_mem_edit_suc.php">
									<div class="form-group">
										...
										<div class="col-sm-7">
                                            ...
                                            <input type="hidden" id="count" name="count" value="<?php echo $count; ?>" class="col-xs-10 col-sm-5"/>											
										</div>
									</div>
									<div class="form-group">
