														...
														<div id="profile-feed-1" class="profile-feed">
															<div class="profile-activity clearfix">
																<div>
                                                                    ...
                                                                    <button type="submit" formaction="pdt_rep_group_ledger_excel.php" class="btn btn-success">Export to Excel</button>
	...
	{ 	
		...
		{   
            ...
            if(tdate < today )
            {
                $.ajax({  
                    type: "POST",  
                    url: "pdt_rep_loanstatement_view.php",  
