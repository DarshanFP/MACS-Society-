<?php	    
	...
	if($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        $sql4 = "SELECT members.*,GroupID,GroupName from members, groups WHERE memgroupid = GroupID AND memid='$memid'";
							...
							<div class="col-xs-12"> <!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" >
									...
									<div class="clearfix form-group">
                                        ...
                                        <?php
                                        if($count==1){											
											echo '<a href="pdt_group_det.php?groupid='.$row4['GroupID'].'"><button class="btn btn-info" type="button">';
                                        }
                                        else{
