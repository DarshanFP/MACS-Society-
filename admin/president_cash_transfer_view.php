					...
					<div class="page-content">
						...
						<div class="row">
                          ...
                          <div class="col-md-3">
												...
												<div class="row">   
													<div class="col-md-8">
														<div class="form-group label-floating">												
															...
															<a href="president.php"><button type="button" class="btn btn-info btn-fill pull-left"><i class="fa fa-arrow-left" style="padding-right:5px;" aria-hidden="true"></i>Back</button></a>
														</div>
													</div>										
													<div class="col-md-4">
														<div class="form-group label-floating">	
                              <?php 
                                if($result4['paymentcash'] > 0)
                                  echo "<a href='president_cash_transfer_cancel.php?cashid=".$cashid."'><button type='button' class='btn btn-info btn-fill pull-right'>Cancel</button></a>";
                                else
                                  echo "<a href='president_cash_transfer_accept.php?cashid=".$cashid."'><button type='button' class='btn btn-info btn-fill pull-right'>Accept</button></a>";
                              ?>
