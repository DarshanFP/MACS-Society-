<?php	    
	...
	if($_SERVER["REQUEST_METHOD"] == "POST"){
		...
		$npass = $_POST['npass'];
		$rpass = $_POST['rpass'];
		$sql = "SELECT * FROM users WHERE userid='$user' AND password = '$pass' AND userstatus = 1";
		$result = mysqli_query($connection,$sql);     	  
		$count = mysqli_num_rows ($result);
		if($count == 1){
			if($npass == $rpass){
				$sql = "UPDATE users SET password='$npass' WHERE userid='$user' AND userstatus = 1";
								...
								<form class="form-horizontal" role="form" method="post">
									...
									<div class="clearfix form-group">
										<div class="col-md-offset-3 col-md-9">
											...
											<a href="president.php"><button class="btn btn-info" type="button">
