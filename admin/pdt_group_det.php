			...
			<div class="main-content">
				<div class="main-content-inner">					
					<div class="page-content">
                        ...
                        <a href='pdt_mem_new.php?groupid=<?php echo $groupid;?>'><button class="btn btn-success">Add New Member</button></a>
                      </p>		
										</div>
										<div class = "col-md-9">
										...
										<table  id="simple-table" class="table  table-bordered table-hover">
											...
											<?php if($count>0){
												...
												{ 	
                                                    ...
                                                    echo "<td align='right'>".number_format($row['middeposits'],2, '.', '')."</td>";
                                                    echo "<td align='right'>".number_format($row['loans'],2, '.', '')."</td>";
													
													echo "<td class='center'>
															  <a href='pdt_mem_edit.php?memid=".$row['memid']."&groupid=".$groupid."'>
...
// 															  </a></td>							  
                                                    ...
                                                    $totalaid = $totalaid + $row['middeposits'];
                                                    $totalloans = $totalloans + $row['loans'];					
												}	
                                                echo "<tr>
                                                    ...
                                                    <td align='right'><b>".number_format($totalaid,2, '.', '')."</b></td>
															...
															<div class="profile-activity clearfix">
																<div>
																	...
																	<table style="font-size:13px" id="simple-table" class="table  table-bordered table-hover">
                                                                        ...
                                                                        //         echo "<td class='center'><a href='pdt_group_mem_allot_close.php?groupid=".$groupid."&&memid=".$row['memid']."'<i class='ace-icon fa fa-times orange'></i></a></td></tr>";
																		// 		$slno = $slno +1;					
																		// 	}				
																		// }
																		?>
                                            ...
                                            <table class="table ">											
                                                <tbody>
                                                <tr> <form action="pdt_group_mem_allot.php" method ="post">
                                                    <td>
                                            ...
                                            <a href="president_group.php"><button class="btn btn-primary" style="float:right;">
     ...
     $("table tr").each(function(index) {
         if (index != 0) {
			 ...
			 var matchedIndex3 = id3.indexOf(value);
			       if (matchedIndex2 == -1 && matchedIndex3 == -1) {
                 $row.hide();
             }
             else {
