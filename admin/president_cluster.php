					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12"> <!-- PAGE CONTENT BEGINS -->
								<div class="row">
									<div class = "col-md-3">	
									  <p style="padding:12px"><a href="pdt_cluster_new.php"><button class="btn btn-success">Add New Cluster</button></a></p>
									 </div>
									 <div class = "col-md-9">	
										...
										<table  id="simple-table" class="table  table-bordered table-hover">
											...
											<?php if($count>0){
												...
												{ 	
												  ...
												  echo "<td><a href='pdt_cluster_det.php?clusterid=".$row['ClusterID']."'>".$row['ClusterID']."</a></td>";					
