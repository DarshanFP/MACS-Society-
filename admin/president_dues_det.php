...
if(isset($_GET['duesid'])){
    ...
    $sql = mysqli_query($connection,"SELECT acc_cashbook.* FROM acc_cashbook, acc_transactions WHERE accno = '$duesid' AND acc_cashbook.TransID = acc_transactions.TransID AND acc_transactions.TransStatus = 1 ");
