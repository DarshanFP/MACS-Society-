...
?>    
    <div class="main-content">
        ...
        <?php
            ...
            $memtransfer = mysqli_query($connection,"SELECT * FROM acc_mem_transfer_dummy WHERE ClusterID='$clusterid'");
        ...
        echo "</tbody></table>";
        ?>
        <a href="accounts.php"><button class="btn btn-primary" style="float:right;">
