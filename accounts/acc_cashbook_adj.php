                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php 
                            ...
                            if($count2>0){
                              ...
                              { 
                                ...
                                echo "<td align='center'>
                                      <a href='acc_cb_adj_del.php?id=".$row2['id']."'><i class='fa fa-close'></i></a>							  
                                    </td></tr>";
                            ...
                            <tr>
                              <td><a href="accounts_cashbook.php"><button type="button" class="btn btn-info btn-fill"><i class="fa fa-arrow-left" aria-hidden="true"></i>Back</button></a></td>
                              <td></td>
                              <td></td>
                              <td></td>
                              <td></td>
                              <td style="float:right;"><?php
                                if($debit == $credit && $debit!= 0 ){
                                  echo "<a href='acc_cb_adj_suc.php'><button type='submit' class='btn btn-info btn-fill' id='proceed'>Proceed</button></a>";                                									
                                }
                                else {
