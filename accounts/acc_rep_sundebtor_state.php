<?php	    
    ...
    $sundebtor = mysqli_query($connection,"SELECT * FROM acc_dues WHERE duestype=1");
    $memdebtor = mysqli_query($connection,"SELECT * FROM members");     
?>
				...
				<div class="main-content-inner">					
                    ...
                    <form method="post" target="_blank">
                        <div class="page-header" >             
                                ...
                                <?php 
                                    echo "<option></option>";                                    
                                    while ($row2 = mysqli_fetch_assoc($sundebtor)) 												
                                    echo "<option value ='".$row2['duesid']."'>".$row2['duesname']."</option>";								
                                    while ($row3 = mysqli_fetch_assoc($memdebtor)) 												
										...
										<div class="col-xs-12 col-sm-10">											
                                            ...
                                            <div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="duesid"></span>
                                                    </div>
                                                </div>
                                                <div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="duesname"></span>
                                                    </div>
                                                </div>
                                                <div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="details"></span>
		...
		{   
            ...
            var tdate = $("#tdate").val();
                ...
                if(fdate <= tdate && tdate <= today )
				{
					$.ajax({  
						type: "POST",  
						url: "acc_rep_sundebtor_view.php",  
