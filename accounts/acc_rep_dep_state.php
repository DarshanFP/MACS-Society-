<?php	    
    ...
    $depid = mysqli_query($connection,"SELECT * FROM acc_deposits");    
?>
				...
				<div class="main-content-inner">					
                    ...
                    <form method="post" target="_blank">
                        <div class="page-header" >             
                                ...
                                <small>          
                                <label style="margin-left:10px">DepositNo.</label>
                                ...
                                <?php 
                                    ...
                                    echo "<option value ='".$row2['depositno']."'>".$row2['depositno']."</option>";								
                                ?>
                                </select> 
									...
									<div id="user-profile-1" class="user-profile row">
										...
										<div class="col-xs-12 col-sm-10">											
											...
											<div class="profile-user-info profile-user-info-striped" id="memdetview">
                                                ...
                                                <div class="profile-info-row">
													<div class="profile-info-name"> Member Office </div>

													<div class="profile-info-value">
														<span class="editable" id="memoffice"></span>
                                                    </div>
                                                </div>
                                            </div>
...
<script type="text/javascript">
    $(document).ready(function()
		{ 	
            ...
            {   
                $('#trows1').hide();
                var depno = $("#depaccno").val();
                //alert(depno);
                $.ajax({  
                    type: "POST",  
                    url: "mem_dep_view.php",  
                    data: {depno: depno},
                    datatype:"json",
                    success: function(data){
                        //alert(data);
