...
if($_SERVER['REQUEST_METHOD']=='POST'){
  ...
  if($count3>0){
    ...
    $sql2 = mysqli_query($connection,"SELECT SubID, SubHead FROM acc_subhead, acc_deposits WHERE acc_subhead.SubID = acc_deposits.subheadid AND memid = '$memid' AND SubID NOT IN (SELECT subheadid FROM acc_cashbook_dummy, acc_subhead WHERE acc_cashbook_dummy.subheadid = acc_subhead.SubID AND acc_subhead.SubHeadModule <> 8 AND memid = '$memid')");
    $count2 = mysqli_num_rows($sql2);
  
    $sql4 = mysqli_query($connection,"SELECT acc_cashbook_dummy.*, SubHead FROM acc_cashbook_dummy,acc_subhead 
                                    WHERE memid = '$memid' AND acc_subhead.SubID = acc_cashbook_dummy.subheadid AND subheadid != 9 AND receiptadj != 0");
    ...
    $sql2 = mysqli_query($connection,"SELECT SubID, SubHead FROM acc_subhead, acc_deposits WHERE acc_subhead.SubID = acc_deposits.subheadid AND memid = '$memid'");
    $count2 = mysqli_num_rows($sql2);
									...
									<div id="user-profile-1" class="user-profile row">										
										<div class="col-xs-12 col-sm-10">											
                                            ...
                                            <div class="content table-responsive table-full-width">
                                                ...
                                                <tbody>
                                                    <tr> <form action="acc_mem_dep_monthly_int_add.php" class="form-horizontal" method ="post">
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if($count4>0){
                                                            ...
                                                            echo "<td align='right'>".$row4['remarks']."</td>";
                                                            echo "<td align='right'>".$row4['receiptadj']."</td>";
                                                            echo "<td align='center'><a href='acc_mem_dep_monthly_int_del.php?id=".$row4['id']."'><i class='fa fa-close'></i></a></td>";
                                                            echo "</tr>";
                                                            $slno = $slno + 1;
                                                            $total = $total + $row4['receiptadj'];
                                                            }
                                                        }
                                                        ?>
                                                        <tr>
                                            ...
                                            <div class="content table-responsive table-full-width" style="float:right;">
                                                <?php 
                                                    if($count4 == 0){
                                                        ...
                                                        echo "<a href='acc_mem_dep_monthly_int_suc.php?memid=".$memid."'><button type='submit' class='btn btn-info btn-fill' id='proceed' onclick='return confirm(&quot Please Check Once, Once submitted cannot be revoked. &quot); return false;'>Proceed</button></a>";                                									
                                                    }
                                                ?>
