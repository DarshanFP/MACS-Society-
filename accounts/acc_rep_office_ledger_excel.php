<?php    
    ...
    $sql11 = mysqli_query($connection,"SELECT * FROM offices WHERE OfficeID='$office'");
    $row11 = mysqli_fetch_assoc($sql11);
    $officename = $row11['OfficeName'];  
    ...
    $output.= "<table style='font-family:verdana; font-size:14px;'>
                <tbody>
                    <tr>";
    $output.= "<td colspan='1'>Branch Name: ".$branchname."</td></tr>";
    $output.= "<tr><td colspan='1'>Office Name: ".$officename."</td></tr><tbody></table>";
	...
	header("Content-Disposition:attachment; filename=$officename _OfficeReport-$monthname _$year.xls");
    echo $output;
?>    