    ...
    if($count2>0){
        ...
        while($row2 = mysqli_fetch_assoc($sql2)){
            if($headingsubhead == $row2['subheadid']){
                ...
                $output .= "<td align='right'>".number_format($row2['receiptcash'],2)."</td>";
                $output .= "<td align='right'>".number_format($row2['paymentcash'],2)."</td>";

                $output .= "<td align='right'>".number_format($row2['receiptadj'],2)."</td>";
                $output .= "<td align='right'>".number_format($row2['paymentadj'],2)."</td>";
                $output .= "</tr>";
