<?php 
    ...
    $cashfirstob = 0;					
 	  ...
 	  if($group != 'All'){
      $sql1 = mysqli_query($connection,"SELECT sum(receiptcash), sum(paymentcash) FROM acc_cashbook, acc_transactions WHERE groupid =  '$group' AND date < '$fromdate' AND acc_cashbook.TransID = acc_transactions.TransID AND acc_transactions.TransStatus	= 1 GROUP BY groupid");
    ...
    $output .= "<table class='table' style='font-family:verdana;'>
                          ...
                          <tr>
                            <td colspan='9' style='text-align:center; font-size:14px;'><b>Receipts & Payments : ".$groupname."</b></td>
                          </tr>";
