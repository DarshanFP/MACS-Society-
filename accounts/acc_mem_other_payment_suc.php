<?php	    
    ...
    $row2 = mysqli_fetch_assoc($sql2);
      ...
      $sql4 = mysqli_query($connection,"INSERT INTO acc_cashbook (`date`, `clusterid`, `groupid`, `TransID`, `memid`, `subheadid`, `details`, `paymentcash`,`remarks`,`entryempid`,`timedate`)
                VALUES('$today','$clusterid','$groupid', '$transid', '$memid', '$subheadid', '$remarks','$amount','$remarks','$user','$timedate')") or die(mysqli_error($connection));	
      ...
      $sql5 = mysqli_query($connection,"UPDATE acc_loan_income SET Status = 2, Remarks = '$remarks' WHERE Status = 0 AND MemID = '$memid' AND SubID = '$subheadid'");	
        //Loan Ledger End  
