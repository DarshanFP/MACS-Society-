<?php	    
    ...
    if(isset($_GET['memid'])){
        ...
        $sql2 = mysqli_query($connection,"SELECT * FROM acc_subhead WHERE SubHeadModule = 3");
								...
								<div>
									<div id="user-profile-1" class="user-profile row">
										...
										<div class="col-xs-12 col-sm-10">											
											...
											<form class="form-horizontal" role="form" method="post" action="acc_mem_loan_new_suc.php">
                                                ...
                                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Type of Loan </label>
                                                    ...
                                                    <?php
                                                        ...
                                                        $subid = $row2['SubID'];
                                                        $loancheck = mysqli_query($connection,"SELECT * FROM acc_loans WHERE memid = '$memid' AND subheadid ='$subid' AND status = 1");
                                                        $loancount = mysqli_num_rows($loancheck);
                                                        if($loancount < 1)
                                                ...
                                                <div class="form-group">
                                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Loan Amount </label>

                                                <div class="col-sm-7">
                                                    <input type="text" id="loan" name="loan" placeholder="Loan Amount" class="col-xs-10 col-sm-5" autocomplete="off" required />
                                                </div>
                                                </div>
