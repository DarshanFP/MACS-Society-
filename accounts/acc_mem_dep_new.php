...
if(isset($_GET['memid'])){
    ...
    $sql2 = mysqli_query($connection,"SELECT * FROM acc_subhead WHERE SubHeadModule = 4");
				...
				<div class="main-content-inner">					
					<div class="page-content">
								...
								<div>
									<div id="user-profile-1" class="user-profile row">
										...
										<div class="col-xs-12 col-sm-10">											
											...
											<form class="form-horizontal" role="form" method="post" action="acc_mem_dep_new_suc.php">
                             ...
                             <select name="subhead" id = "group" class="col-xs-10 col-sm-5" autocomplete="off" required>
                              <?php
                                while($row2 = mysqli_fetch_assoc($sql2)){
                                  $subid = $row2['SubID'];
                                  $depcheck = mysqli_query($connection,"SELECT * FROM acc_deposits WHERE memid = '$memid' AND subheadid ='$subid' AND status = 1");
                                  $depcount = mysqli_num_rows($depcheck);
                                  if($depcount < 1)
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-5">
                            <input type="date" id="form-field-3" name="dod" placeholder="mm/dd/yyyy"  class="col-xs-10 col-sm-5" autocomplete="off" required />
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-7">
                            <input type="text" id="form-field-1" name="deposit" placeholder="Amount" class="col-xs-10 col-sm-5" autocomplete="off" required />
                          </div>
                        </div>

                        <div class="form-group">
                          <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Monthly Amount </label>

                          <div class="col-sm-7">
                            <input type="text" id="form-field-1" name="installment" placeholder="Monthly Amount" class="col-xs-10 col-sm-5" autocomplete="off" required />
                          </div>
                        </div>
